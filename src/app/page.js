			...
			>
				<div className="container flex flex-col md:flex-row items-center px-4 md:px-8">
					...
					>
						...
						⭐Real-Time Insights with Advanced Data & Temperature Loggers⭐
						</div>
						<h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-6">
						Revolutionizing{" "}
							<span className="text-indigo-600">Global Cold Chains{" "}</span>with{" "}
				...
				>
					{[
						{ src: "/images/hero1.png", text: "Food Industry" },
						{ src: "/images/hero2.png", text: "Pharmaceutical Industry" },
						{ src: "/images/ai.png", text: "Global Transportation" },
					].map((item, index) => (
						<div
							key={index}
